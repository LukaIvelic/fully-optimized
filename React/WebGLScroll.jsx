/*
    Code that implements WebGL animations while scrolling.
    ...
    Execute:
        ...
        - Control scroll effect with 'requestAnimationFrame'
        - Dispose materials after usage
        - Return component
*/
...
export default function WebGLScrollAnimationComponent({ Id, Width, Height, ImgSrc }) {
    ...
    useEffect(() => {
        ...
        const planeGeometry = new THREE.PlaneGeometry(15, 10, 6, 6);
        ...
        const handleWheel = () => {
            if (scrollSpeed.current < 2) {
                scrollSpeed.current += 0.2;
            }
        };
...
const vertexShaderCode = `
    ...
    void main() {
        ...
        modified_position.x += cos(position.y / 5.0) * u_scroll_speed;
